...
Provide concise advice for this situation:
\${input}\`;
  ...
  return (
    <div style={{ padding: '1rem', backgroundColor: '#111', color: 'white' }}>
      ...
      <textarea rows={3} value={input} onChange={(e) => setInput(e.target.value)} style={{ width: '100%' }} />
      <button onClick={handleAsk} style={{ marginTop: '0.5rem' }}>Ask</button>
